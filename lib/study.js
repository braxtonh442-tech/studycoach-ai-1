...
Use the recent conversation to understand follow-up words like "she", "it", "that", "they", or "explain again".
`,
...
Please:
1. Read the homework image
2. Mark it out of 10
3. Explain what is correct
4. Explain mistakes
5. Give step-by-step improvement advice
6. Suggest what to revise next
`
                },
                {
                  type: "input_image",
